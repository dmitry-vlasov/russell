...
$)
  ...
  ${
    ...
    $( At least one individual exists.  Weaker version of ~ a9e .  When
       ...
       3-Aug-2017.) $)
    a9ev $p |- E. x x = y $=
      vx vy weq vx wex vx vy weq wn vx wal wn vx vy ax9v vx vy weq vx df-ex
      mpbir $.
  $}
  ...
  ${
    ...
    spimw $p |- ( A. x ph -> ps ) $=
      vx vy weq wn vx wal wn wph vx wal wps wi vx vy ax9v wph wps vx vy spimw.1
      spimw.2 spimfw ax-mp $.
  $}
  ...
  ${
    ...
    spimvw $p |- ( A. x ph -> ps ) $=
      wph wps vx vy wps wn vx ax-17 spimvw.1 spimw $.
  $}
  ...
  ${
    ...
    $( Weak version of ~ sp .  Uses only Tarski's FOL axiom schemes.
       ...
       13-Aug-2017.) $)
    spnfw $p |- ( A. x ph -> ph ) $=
      wph wph vx vy spnfw.1 vx vy weq wph idd spimw $.
  $}
  ...
  ${
    ...
    cbvaliw $p |- ( A. x ph -> A. y ps ) $=
      wph vx wal wps vy cbvaliw.1 wph wps vx vy cbvaliw.2 cbvaliw.3 spimw
      alrimih $.
  $}
  ...
  ${
    ...
    cbvalivw $p |- ( A. x ph -> A. y ps ) $=
      wph vx wal wps vy wph wps vx vy cbvalivw.1 spimvw alrimiv $.
  $}
