...
${
	...
	iru_0 $f set y $.
	fru_0 $f set x $.
	ru $p |- { x | x e/ x } e/ _V $= fru_0 cv fru_0 cv wnel fru_0 cab cvv wnel fru_0 cv fru_0 cv wnel fru_0 cab cvv wcel wn fru_0 cv fru_0 cv wnel fru_0 cab cvv wcel iru_0 cv fru_0 cv fru_0 cv wnel fru_0 cab wceq iru_0 wex iru_0 cv fru_0 cv fru_0 cv wnel fru_0 cab wceq iru_0 iru_0 cv fru_0 cv fru_0 cv wnel fru_0 cab wceq fru_0 cv iru_0 cv wcel fru_0 cv fru_0 cv wnel wb fru_0 wal fru_0 cv iru_0 cv wcel fru_0 cv fru_0 cv wnel wb fru_0 wal iru_0 cv iru_0 cv wcel iru_0 cv iru_0 cv wcel wn wb iru_0 cv iru_0 cv wcel pm5.19 fru_0 cv iru_0 cv wcel fru_0 cv fru_0 cv wnel wb iru_0 cv iru_0 cv wcel iru_0 cv iru_0 cv wcel wn wb fru_0 iru_0 fru_0 cv iru_0 cv wceq fru_0 cv iru_0 cv wcel iru_0 cv iru_0 cv wcel fru_0 cv fru_0 cv wnel iru_0 cv iru_0 cv wcel wn fru_0 cv iru_0 cv iru_0 cv eleq1 fru_0 cv fru_0 cv wnel fru_0 cv fru_0 cv wcel wn fru_0 cv iru_0 cv wceq iru_0 cv iru_0 cv wcel wn fru_0 cv fru_0 cv df-nel fru_0 cv iru_0 cv wceq fru_0 cv fru_0 cv wcel iru_0 cv iru_0 cv wcel fru_0 cv iru_0 cv wceq fru_0 cv iru_0 cv fru_0 cv iru_0 cv fru_0 cv iru_0 cv wceq id fru_0 cv iru_0 cv wceq id eleq12d notbid syl5bb bibi12d spv mto fru_0 cv fru_0 cv wnel fru_0 iru_0 cv abeq2 mtbir nex iru_0 fru_0 cv fru_0 cv wnel fru_0 cab isset mtbir fru_0 cv fru_0 cv wnel fru_0 cab cvv df-nel mpbir $.
$}
