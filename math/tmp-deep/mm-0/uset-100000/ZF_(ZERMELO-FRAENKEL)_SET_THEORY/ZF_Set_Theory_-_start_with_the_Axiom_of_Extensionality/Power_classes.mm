...
${
	...
	fpwjust_1 $f set y $.
	fpwjust_2 $f class A $.
	pwjust $p |- { x | x C_ A } = { y | y C_ A } $= fpwjust_0 cv fpwjust_2 wss fpwjust_0 cab ipwjust_0 cv fpwjust_2 wss ipwjust_0 cab fpwjust_1 cv fpwjust_2 wss fpwjust_1 cab fpwjust_0 cv fpwjust_2 wss ipwjust_0 cv fpwjust_2 wss fpwjust_0 ipwjust_0 fpwjust_0 cv ipwjust_0 cv fpwjust_2 sseq1 cbvabv ipwjust_0 cv fpwjust_2 wss fpwjust_1 cv fpwjust_2 wss ipwjust_0 fpwjust_1 ipwjust_0 cv fpwjust_1 cv fpwjust_2 sseq1 cbvabv eqtri $.
$}
...
${
	...
	fpweq_0 $f class A $.
	fpweq_1 $f class B $.
	pweq $p |- ( A = B -> ~P A = ~P B ) $= fpweq_0 fpweq_1 wceq ipweq_0 cv fpweq_0 wss ipweq_0 cab ipweq_0 cv fpweq_1 wss ipweq_0 cab fpweq_0 cpw fpweq_1 cpw fpweq_0 fpweq_1 wceq ipweq_0 cv fpweq_0 wss ipweq_0 cv fpweq_1 wss ipweq_0 fpweq_0 fpweq_1 ipweq_0 cv sseq2 abbidv ipweq_0 fpweq_0 df-pw ipweq_0 fpweq_1 df-pw 3eqtr4g $.
$}
...
${
	...
	felpw_1 $f class B $.
	eelpw_0 $e |- A e. _V $.
	elpw $p |- ( A e. ~P B <-> A C_ B ) $= ielpw_0 cv felpw_1 wss felpw_0 felpw_1 wss ielpw_0 felpw_0 felpw_1 cpw eelpw_0 ielpw_0 cv felpw_0 felpw_1 sseq1 ielpw_0 felpw_1 df-pw elab2 $.
$}
...
${
	...
	felpwg_1 $f class B $.
	felpwg_2 $f class V $.
	elpwg $p |- ( A e. V -> ( A e. ~P B <-> A C_ B ) ) $= ielpwg_0 cv felpwg_1 cpw wcel ielpwg_0 cv felpwg_1 wss felpwg_0 felpwg_1 cpw wcel felpwg_0 felpwg_1 wss ielpwg_0 felpwg_0 felpwg_2 ielpwg_0 cv felpwg_0 felpwg_1 cpw eleq1 ielpwg_0 cv felpwg_0 felpwg_1 sseq1 ielpwg_0 cv felpwg_1 ielpwg_0 vex elpw vtoclbg $.
$}
...
${
	...
	fnfpw_1 $f class A $.
	enfpw_0 $e |- F/_ x A $.
	nfpw $p |- F/_ x ~P A $= fnfpw_0 fnfpw_1 cpw infpw_0 cv fnfpw_1 wss infpw_0 cab infpw_0 fnfpw_1 df-pw infpw_0 cv fnfpw_1 wss fnfpw_0 infpw_0 fnfpw_0 infpw_0 cv fnfpw_1 fnfpw_0 infpw_0 cv nfcv enfpw_0 nfss nfab nfcxfr $.
$}
...
${
	...
	fpwss_1 $f class A $.
	fpwss_2 $f class B $.
	pwss $p |- ( ~P A C_ B <-> A. x ( x C_ A -> x e. B ) ) $= fpwss_1 cpw fpwss_2 wss fpwss_0 cv fpwss_1 cpw wcel fpwss_0 cv fpwss_2 wcel wi fpwss_0 wal fpwss_0 cv fpwss_1 wss fpwss_0 cv fpwss_2 wcel wi fpwss_0 wal fpwss_0 fpwss_1 cpw fpwss_2 dfss2 fpwss_0 cv fpwss_1 cpw wcel fpwss_0 cv fpwss_2 wcel wi fpwss_0 cv fpwss_1 wss fpwss_0 cv fpwss_2 wcel wi fpwss_0 fpwss_0 cv fpwss_1 cpw wcel fpwss_0 cv fpwss_1 wss fpwss_0 cv fpwss_2 wcel fpwss_0 cv fpwss_1 wss fpwss_0 fpwss_1 cpw fpwss_0 fpwss_1 df-pw abeq2i imbi1i albii bitri $.
$}
