...
${
	...
	fcdeqi_2 $f set y $.
	ecdeqi_0 $e |- ( x = y -> ph ) $.
	cdeqi $p |- CondEq ( x = y -> ph ) $= fcdeqi_0 fcdeqi_1 fcdeqi_2 wcdeq fcdeqi_1 cv fcdeqi_2 cv wceq fcdeqi_0 wi ecdeqi_0 fcdeqi_0 fcdeqi_1 fcdeqi_2 df-cdeq mpbir $.
$}
...
${
	...
	cdeqri $p |- ( x = y -> ph ) $= fcdeqri_0 fcdeqri_1 fcdeqri_2 wcdeq fcdeqri_1 cv fcdeqri_2 cv wceq fcdeqri_0 wi ecdeqri_0 fcdeqri_0 fcdeqri_1 fcdeqri_2 df-cdeq mpbi $.
$}
...
${
	...
	fcdeqth_2 $f set y $.
	ecdeqth_0 $e |- ph $.
	cdeqth $p |- CondEq ( x = y -> ph ) $= fcdeqth_0 fcdeqth_1 fcdeqth_2 fcdeqth_0 fcdeqth_1 cv fcdeqth_2 cv wceq ecdeqth_0 a1i cdeqi $.
$}
...
${
	...
	cdeqnot $p |- CondEq ( x = y -> ( -. ph <-> -. ps ) ) $= fcdeqnot_0 wn fcdeqnot_1 wn wb fcdeqnot_2 fcdeqnot_3 fcdeqnot_2 cv fcdeqnot_3 cv wceq fcdeqnot_0 fcdeqnot_1 fcdeqnot_0 fcdeqnot_1 wb fcdeqnot_2 fcdeqnot_3 ecdeqnot_0 cdeqri notbid cdeqi $.
$}
...
${
	...
	cdeqal $p |- CondEq ( x = y -> ( A. z ph <-> A. z ps ) ) $= fcdeqal_0 fcdeqal_4 wal fcdeqal_1 fcdeqal_4 wal wb fcdeqal_2 fcdeqal_3 fcdeqal_2 cv fcdeqal_3 cv wceq fcdeqal_0 fcdeqal_1 fcdeqal_4 fcdeqal_0 fcdeqal_1 wb fcdeqal_2 fcdeqal_3 ecdeqal_0 cdeqri albidv cdeqi $.
$}
...
${
	...
	cdeqab $p |- CondEq ( x = y -> { z | ph } = { z | ps } ) $= fcdeqab_0 fcdeqab_4 cab fcdeqab_1 fcdeqab_4 cab wceq fcdeqab_2 fcdeqab_3 fcdeqab_2 cv fcdeqab_3 cv wceq fcdeqab_0 fcdeqab_1 fcdeqab_4 fcdeqab_0 fcdeqab_1 wb fcdeqab_2 fcdeqab_3 ecdeqab_0 cdeqri abbidv cdeqi $.
$}
$( Distribute conditional equality over quantification.  (Contributed by
         Mario Carneiro, 11-Aug-2016.) $)
${
...
${
	...
	cdeqab1 $p |- CondEq ( x = y -> { x | ph } = { y | ps } ) $= fcdeqab1_0 fcdeqab1_2 cab fcdeqab1_1 fcdeqab1_3 cab wceq fcdeqab1_2 fcdeqab1_3 fcdeqab1_0 fcdeqab1_2 cab fcdeqab1_1 fcdeqab1_3 cab wceq fcdeqab1_2 cv fcdeqab1_3 cv wceq fcdeqab1_0 fcdeqab1_1 fcdeqab1_2 fcdeqab1_3 fcdeqab1_0 fcdeqab1_1 wb fcdeqab1_2 fcdeqab1_3 ecdeqab1_0 cdeqri cbvabv a1i cdeqi $.
$}
...
${
	...
	cdeqim $p |- CondEq ( x = y -> ( ( ph -> ch ) <-> ( ps -> th ) ) ) $= fcdeqim_0 fcdeqim_2 wi fcdeqim_1 fcdeqim_3 wi wb fcdeqim_4 fcdeqim_5 fcdeqim_4 cv fcdeqim_5 cv wceq fcdeqim_0 fcdeqim_1 fcdeqim_2 fcdeqim_3 fcdeqim_0 fcdeqim_1 wb fcdeqim_4 fcdeqim_5 ecdeqim_0 cdeqri fcdeqim_2 fcdeqim_3 wb fcdeqim_4 fcdeqim_5 ecdeqim_1 cdeqri imbi12d cdeqi $.
$}
...
${
	fcdeqcv_0 $f set x $.
	fcdeqcv_1 $f set y $.
	cdeqcv $p |- CondEq ( x = y -> x = y ) $= fcdeqcv_0 cv fcdeqcv_1 cv wceq fcdeqcv_0 fcdeqcv_1 fcdeqcv_0 cv fcdeqcv_1 cv wceq id cdeqi $.
$}
...
${
	...
	cdeqeq $p |- CondEq ( x = y -> ( A = C <-> B = D ) ) $= fcdeqeq_2 fcdeqeq_4 wceq fcdeqeq_3 fcdeqeq_5 wceq wb fcdeqeq_0 fcdeqeq_1 fcdeqeq_0 cv fcdeqeq_1 cv wceq fcdeqeq_2 fcdeqeq_3 fcdeqeq_4 fcdeqeq_5 fcdeqeq_2 fcdeqeq_3 wceq fcdeqeq_0 fcdeqeq_1 ecdeqeq_0 cdeqri fcdeqeq_4 fcdeqeq_5 wceq fcdeqeq_0 fcdeqeq_1 ecdeqeq_1 cdeqri eqeq12d cdeqi $.
$}
...
${
	...
	cdeqel $p |- CondEq ( x = y -> ( A e. C <-> B e. D ) ) $= fcdeqel_2 fcdeqel_4 wcel fcdeqel_3 fcdeqel_5 wcel wb fcdeqel_0 fcdeqel_1 fcdeqel_0 cv fcdeqel_1 cv wceq fcdeqel_2 fcdeqel_3 fcdeqel_4 fcdeqel_5 fcdeqel_2 fcdeqel_3 wceq fcdeqel_0 fcdeqel_1 ecdeqel_0 cdeqri fcdeqel_4 fcdeqel_5 wceq fcdeqel_0 fcdeqel_1 ecdeqel_1 cdeqri eleq12d cdeqi $.
$}
...
${
	...
	nfccdeq $p |- A = B $= infccdeq_0 fnfccdeq_2 fnfccdeq_3 infccdeq_0 cv fnfccdeq_2 wcel infccdeq_0 cv fnfccdeq_3 wcel fnfccdeq_0 fnfccdeq_1 fnfccdeq_0 infccdeq_0 fnfccdeq_2 enfccdeq_0 nfcri fnfccdeq_0 fnfccdeq_1 infccdeq_0 cv infccdeq_0 cv fnfccdeq_2 fnfccdeq_3 infccdeq_0 cv infccdeq_0 cv wceq fnfccdeq_0 fnfccdeq_1 infccdeq_0 equid cdeqth enfccdeq_1 cdeqel nfcdeq eqriv $.
$}
