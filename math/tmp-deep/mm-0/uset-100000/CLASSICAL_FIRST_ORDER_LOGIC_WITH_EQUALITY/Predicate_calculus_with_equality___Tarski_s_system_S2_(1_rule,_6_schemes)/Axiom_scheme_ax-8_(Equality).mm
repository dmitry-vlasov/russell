...
${
	...
	iequid_0 $f set y $.
	fequid_0 $f set x $.
	equid $p |- x = x $= fequid_0 fequid_0 weq fequid_0 fequid_0 weq wn iequid_0 wal fequid_0 fequid_0 weq wn iequid_0 wal iequid_0 fequid_0 weq wn iequid_0 wal iequid_0 fequid_0 ax9v fequid_0 fequid_0 weq wn iequid_0 fequid_0 weq wn iequid_0 iequid_0 fequid_0 weq fequid_0 fequid_0 weq iequid_0 fequid_0 weq fequid_0 fequid_0 weq iequid_0 fequid_0 fequid_0 ax-8 pm2.43i con3i alimi mto fequid_0 fequid_0 weq wn iequid_0 ax-17 mt3 $.
$}
...
${
	...
	fnfequid_0 $f set x $.
	fnfequid_1 $f set y $.
	nfequid $p |- F/ y x = x $= fnfequid_0 fnfequid_0 weq fnfequid_1 fnfequid_0 equid nfth $.
$}
...
${
	...
	fequcomi_0 $f set x $.
	fequcomi_1 $f set y $.
	equcomi $p |- ( x = y -> y = x ) $= fequcomi_0 fequcomi_1 weq fequcomi_0 fequcomi_0 weq fequcomi_1 fequcomi_0 weq fequcomi_0 equid fequcomi_0 fequcomi_1 fequcomi_0 ax-8 mpi $.
$}
...
${
	...
	fequcom_0 $f set x $.
	fequcom_1 $f set y $.
	equcom $p |- ( x = y <-> y = x ) $= fequcom_0 fequcom_1 weq fequcom_1 fequcom_0 weq fequcom_0 fequcom_1 equcomi fequcom_1 fequcom_0 equcomi impbii $.
$}
...
${
	...
	fequcoms_2 $f set y $.
	eequcoms_0 $e |- ( x = y -> ph ) $.
	equcoms $p |- ( y = x -> ph ) $= fequcoms_2 fequcoms_1 weq fequcoms_1 fequcoms_2 weq fequcoms_0 fequcoms_2 fequcoms_1 equcomi eequcoms_0 syl $.
$}
...
${
	...
	fequequ1_1 $f set y $.
	fequequ1_2 $f set z $.
	equequ1 $p |- ( x = y -> ( x = z <-> y = z ) ) $= fequequ1_0 fequequ1_1 weq fequequ1_0 fequequ1_2 weq fequequ1_1 fequequ1_2 weq fequequ1_0 fequequ1_1 fequequ1_2 ax-8 fequequ1_1 fequequ1_2 weq fequequ1_0 fequequ1_2 weq wi fequequ1_1 fequequ1_0 fequequ1_1 fequequ1_0 fequequ1_2 ax-8 equcoms impbid $.
$}
...
${
	...
	equequ1OLD $p |- ( x = y -> ( x = z <-> y = z ) ) $= fequequ1OLD_0 fequequ1OLD_1 weq fequequ1OLD_0 fequequ1OLD_2 weq fequequ1OLD_1 fequequ1OLD_2 weq fequequ1OLD_0 fequequ1OLD_1 fequequ1OLD_2 ax-8 fequequ1OLD_0 fequequ1OLD_1 weq fequequ1OLD_1 fequequ1OLD_0 weq fequequ1OLD_1 fequequ1OLD_2 weq fequequ1OLD_0 fequequ1OLD_2 weq wi fequequ1OLD_0 fequequ1OLD_1 equcomi fequequ1OLD_1 fequequ1OLD_0 fequequ1OLD_2 ax-8 syl impbid $.
$}
$( An equivalence law for equality.  (Contributed by NM, 5-Aug-1993.)  (Proof
...
${
	...
	fequequ2_1 $f set y $.
	fequequ2_2 $f set z $.
	equequ2 $p |- ( x = y -> ( z = x <-> z = y ) ) $= fequequ2_0 fequequ2_1 weq fequequ2_0 fequequ2_2 weq fequequ2_1 fequequ2_2 weq fequequ2_2 fequequ2_0 weq fequequ2_2 fequequ2_1 weq fequequ2_0 fequequ2_1 fequequ2_2 equequ1 fequequ2_0 fequequ2_2 equcom fequequ2_1 fequequ2_2 equcom 3bitr3g $.
$}
...
${
	$v x $.
	fstdpc6_0 $f set x $.
	stdpc6 $p |- A. x x = x $= fstdpc6_0 fstdpc6_0 weq fstdpc6_0 fstdpc6_0 equid ax-gen $.
$}
...
${
	...
	fequtr_1 $f set y $.
	fequtr_2 $f set z $.
	equtr $p |- ( x = y -> ( y = z -> x = z ) ) $= fequtr_1 fequtr_2 weq fequtr_0 fequtr_2 weq wi fequtr_1 fequtr_0 fequtr_1 fequtr_0 fequtr_2 ax-8 equcoms $.
$}
...
${
	...
	fequtrr_1 $f set y $.
	fequtrr_2 $f set z $.
	equtrr $p |- ( x = y -> ( z = x -> z = y ) ) $= fequtrr_2 fequtrr_0 weq fequtrr_0 fequtrr_1 weq fequtrr_2 fequtrr_1 weq fequtrr_2 fequtrr_0 fequtrr_1 equtr com12 $.
$}
...
${
	...
	fequtr2_1 $f set y $.
	fequtr2_2 $f set z $.
	equtr2 $p |- ( ( x = z /\ y = z ) -> x = y ) $= fequtr2_1 fequtr2_2 weq fequtr2_0 fequtr2_2 weq fequtr2_0 fequtr2_1 weq fequtr2_0 fequtr2_2 weq fequtr2_0 fequtr2_1 weq wi fequtr2_2 fequtr2_1 fequtr2_2 fequtr2_1 fequtr2_0 equtrr equcoms impcom $.
$}
...
${
	...
	fax12b_1 $f set y $.
	fax12b_2 $f set z $.
	ax12b $p |- ( ( -. x = y -> ( y = z -> A. x y = z ) ) <-> ( -. x = y -> ( -. x = z -> ( y = z -> A. x y = z ) ) ) ) $= fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi fax12b_0 fax12b_2 weq wn fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi id a1dd fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi fax12b_1 fax12b_2 weq fax12b_0 wal fax12b_0 fax12b_1 weq wn fax12b_1 fax12b_2 weq fax12b_0 fax12b_2 weq wn fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi fax12b_1 fax12b_2 weq fax12b_0 wal wi fax12b_1 fax12b_2 weq fax12b_0 fax12b_2 weq fax12b_0 fax12b_1 weq fax12b_0 fax12b_2 weq fax12b_0 fax12b_1 weq wi fax12b_2 fax12b_1 fax12b_2 fax12b_1 fax12b_0 equtrr equcoms con3rr3 fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi fax12b_1 fax12b_2 weq fax12b_0 wal wi fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal fax12b_0 fax12b_1 weq wn fax12b_0 fax12b_2 weq wn fax12b_1 fax12b_2 weq fax12b_1 fax12b_2 weq fax12b_0 wal wi wi wi id com4l com23 mpdd com3r impbii $.
$}
...
${
	...
	fax12bOLD_1 $f set y $.
	fax12bOLD_2 $f set z $.
	ax12bOLD $p |- ( ( -. x = y -> ( y = z -> A. x y = z ) ) <-> ( -. x = y -> ( -. x = z -> ( y = z -> A. x y = z ) ) ) ) $= fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal bi2.04 fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq fax12bOLD_0 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wi fax12bOLD_2 fax12bOLD_1 fax12bOLD_2 fax12bOLD_1 fax12bOLD_0 equtrr equcoms con3d pm4.71d imbi1d pm5.74i bitri fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn wa fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal bi2.04 bitri fax12bOLD_0 fax12bOLD_1 weq wn fax12bOLD_0 fax12bOLD_2 weq wn fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_1 fax12bOLD_2 weq fax12bOLD_0 wal wi impexp bitri $.
$}
...
${
	...
	espfw_2 $e |- ( -. ph -> A. y -. ph ) $.
	espfw_3 $e |- ( x = y -> ( ph <-> ps ) ) $.
	spfw $p |- ( A. x ph -> ph ) $= fspfw_0 fspfw_2 wal fspfw_1 wi fspfw_0 fspfw_2 wal fspfw_0 wi fspfw_3 fspfw_0 fspfw_2 wal fspfw_0 fspfw_2 wal fspfw_3 wal fspfw_0 fspfw_2 wal fspfw_1 wi fspfw_3 wal fspfw_1 fspfw_3 wal fspfw_0 espfw_1 fspfw_0 fspfw_2 wal fspfw_1 fspfw_3 ax-5 fspfw_1 fspfw_0 fspfw_3 fspfw_2 espfw_2 fspfw_1 fspfw_0 wi fspfw_2 fspfw_3 fspfw_2 fspfw_3 weq fspfw_0 fspfw_1 espfw_3 biimprd equcoms spimw syl56 fspfw_0 fspfw_1 fspfw_2 fspfw_3 espfw_0 fspfw_2 fspfw_3 weq fspfw_0 fspfw_1 espfw_3 biimpd spimw mpg $.
$}
...
${
	...
	spnfwOLD $p |- ( A. x ph -> ph ) $= fspnfwOLD_0 fspnfwOLD_0 fspnfwOLD_1 ispnfwOLD_0 espnfwOLD_0 fspnfwOLD_0 fspnfwOLD_1 wal ispnfwOLD_0 ax-17 fspnfwOLD_0 wn ispnfwOLD_0 ax-17 fspnfwOLD_1 ispnfwOLD_0 weq fspnfwOLD_0 biidd spfw $.
$}
...
${
	...
	fspvw_0 $f wff ph $.
	fspvw_1 $f set x $.
	spvw $p |- ( A. x ph -> ph ) $= fspvw_0 fspvw_0 fspvw_1 ispvw_0 fspvw_1 ispvw_0 weq fspvw_0 biidd spw $.
$}
...
${
	...
	fspfalw_1 $f set x $.
	espfalw_0 $e |- -. ph $.
	spfalw $p |- ( A. x ph -> ph ) $= fspfalw_0 wfal fspfalw_1 ispfalw_0 fspfalw_0 wfal wb fspfalw_1 ispfalw_0 weq fspfalw_0 espfalw_0 bifal a1i spw $.
$}
...
${
	...
	f19.2_0 $f wff ph $.
	f19.2_1 $f set x $.
	19.2 $p |- ( A. x ph -> E. x ph ) $= f19.2_1 f19.2_1 weq wn f19.2_1 wal wn f19.2_0 f19.2_1 wal f19.2_0 f19.2_1 wex wi f19.2_1 f19.2_1 weq wn f19.2_1 wal f19.2_1 f19.2_1 weq f19.2_1 equid f19.2_1 f19.2_1 weq wn f19.2_1 f19.2_1 f19.2_1 weq f19.2_1 equid notnoti spfalw mt2 f19.2_0 f19.2_0 f19.2_1 f19.2_1 f19.2_1 f19.2_1 weq f19.2_0 idd speimfw ax-mp $.
$}
...
${
	...
	cbvalw $p |- ( A. x ph <-> A. y ps ) $= fcbvalw_0 fcbvalw_2 wal fcbvalw_1 fcbvalw_3 wal fcbvalw_0 fcbvalw_1 fcbvalw_2 fcbvalw_3 ecbvalw_0 ecbvalw_1 fcbvalw_2 fcbvalw_3 weq fcbvalw_0 fcbvalw_1 ecbvalw_4 biimpd cbvaliw fcbvalw_1 fcbvalw_0 fcbvalw_3 fcbvalw_2 ecbvalw_2 ecbvalw_3 fcbvalw_1 fcbvalw_0 wi fcbvalw_2 fcbvalw_3 fcbvalw_2 fcbvalw_3 weq fcbvalw_0 fcbvalw_1 ecbvalw_4 biimprd equcoms cbvaliw impbii $.
$}
$( Change bound variable.  Uses only Tarski's FOL axiom schemes.
       (Contributed by NM, 9-Apr-2017.) $)
${
	...
	cbvalvw $p |- ( A. x ph <-> A. y ps ) $= fcbvalvw_0 fcbvalvw_2 wal fcbvalvw_1 fcbvalvw_3 wal fcbvalvw_0 fcbvalvw_1 fcbvalvw_2 fcbvalvw_3 fcbvalvw_2 fcbvalvw_3 weq fcbvalvw_0 fcbvalvw_1 ecbvalvw_0 biimpd cbvalivw fcbvalvw_1 fcbvalvw_0 fcbvalvw_3 fcbvalvw_2 fcbvalvw_1 fcbvalvw_0 wi fcbvalvw_2 fcbvalvw_3 fcbvalvw_2 fcbvalvw_3 weq fcbvalvw_0 fcbvalvw_1 ecbvalvw_0 biimprd equcoms cbvalivw impbii $.
$}
$( Change bound variable.  Uses only Tarski's FOL axiom schemes.
...
${
	...
	alcomiw $p |- ( A. x A. y ph -> A. y A. x ph ) $= falcomiw_0 falcomiw_3 wal falcomiw_2 wal falcomiw_1 falcomiw_4 wal falcomiw_2 wal falcomiw_1 falcomiw_4 wal falcomiw_2 wal falcomiw_3 wal falcomiw_0 falcomiw_2 wal falcomiw_3 wal falcomiw_0 falcomiw_3 wal falcomiw_1 falcomiw_4 wal falcomiw_2 falcomiw_0 falcomiw_1 falcomiw_3 falcomiw_4 falcomiw_3 falcomiw_4 weq falcomiw_0 falcomiw_1 ealcomiw_0 biimpd cbvalivw alimi falcomiw_1 falcomiw_4 wal falcomiw_2 wal falcomiw_3 ax-17 falcomiw_1 falcomiw_4 wal falcomiw_2 wal falcomiw_0 falcomiw_2 wal falcomiw_3 falcomiw_1 falcomiw_4 wal falcomiw_0 falcomiw_2 falcomiw_1 falcomiw_0 falcomiw_4 falcomiw_3 falcomiw_1 falcomiw_0 wi falcomiw_3 falcomiw_4 falcomiw_3 falcomiw_4 weq falcomiw_0 falcomiw_1 ealcomiw_0 biimprd equcoms spimvw alimi alimi 3syl $.
$}
...
${
	...
	hba1w $p |- ( A. x ph -> A. x A. x ph ) $= fhba1w_0 fhba1w_2 wal fhba1w_0 fhba1w_2 wal wn fhba1w_2 wal wn fhba1w_0 fhba1w_2 wal wn fhba1w_2 wal wn fhba1w_2 wal fhba1w_0 fhba1w_2 wal fhba1w_2 wal fhba1w_0 fhba1w_2 wal wn fhba1w_2 wal fhba1w_0 fhba1w_2 wal fhba1w_0 fhba1w_2 wal wn fhba1w_1 fhba1w_3 wal wn fhba1w_2 fhba1w_3 fhba1w_2 fhba1w_3 weq fhba1w_0 fhba1w_2 wal fhba1w_1 fhba1w_3 wal fhba1w_0 fhba1w_2 wal fhba1w_1 fhba1w_3 wal wb fhba1w_2 fhba1w_3 weq fhba1w_0 fhba1w_1 fhba1w_2 fhba1w_3 ehba1w_0 cbvalvw a1i notbid spw con2i fhba1w_0 fhba1w_2 wal wn fhba1w_1 fhba1w_3 wal wn fhba1w_2 fhba1w_3 fhba1w_2 fhba1w_3 weq fhba1w_0 fhba1w_2 wal fhba1w_1 fhba1w_3 wal fhba1w_0 fhba1w_2 wal fhba1w_1 fhba1w_3 wal wb fhba1w_2 fhba1w_3 weq fhba1w_0 fhba1w_1 fhba1w_2 fhba1w_3 ehba1w_0 cbvalvw a1i notbid hbn1w fhba1w_0 fhba1w_2 wal wn fhba1w_2 wal wn fhba1w_0 fhba1w_2 wal fhba1w_2 fhba1w_0 fhba1w_2 wal fhba1w_0 fhba1w_2 wal wn fhba1w_2 wal fhba1w_0 fhba1w_1 fhba1w_2 fhba1w_3 ehba1w_0 hbn1w con1i alimi 3syl $.
$}
...
${
	...
	hbe1w $p |- ( E. x ph -> A. x E. x ph ) $= fhbe1w_0 fhbe1w_2 wex fhbe1w_0 wn fhbe1w_2 wal wn fhbe1w_2 fhbe1w_0 fhbe1w_2 df-ex fhbe1w_0 wn fhbe1w_1 wn fhbe1w_2 fhbe1w_3 fhbe1w_2 fhbe1w_3 weq fhbe1w_0 fhbe1w_1 ehbe1w_0 notbid hbn1w hbxfrbi $.
$}
