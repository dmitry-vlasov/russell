...
${
	fweq_0 $f set x $.
	fweq_1 $f set y $.
	weq $p wff x = y $= fweq_0 cv fweq_1 cv wceq $.
$}
$( --- End of patch to prevent connective overloading $)
$( --- Start of old code before overloading prevention patch. $)
$( @( Extend wff definition to include atomic formulas using the equality
...
${
	...
	fequs3_1 $f set x $.
	fequs3_2 $f set y $.
	equs3 $p |- ( E. x ( x = y /\ ph ) <-> -. A. x ( x = y -> -. ph ) ) $= fequs3_1 fequs3_2 weq fequs3_0 wn wi fequs3_1 wal fequs3_1 fequs3_2 weq fequs3_0 wa fequs3_1 wex fequs3_1 fequs3_2 weq fequs3_0 fequs3_1 alinexa con2bii $.
$}
...
${
	...
	speimfw $p |- ( -. A. x -. x = y -> ( A. x ph -> E. x ps ) ) $= fspeimfw_2 fspeimfw_3 weq fspeimfw_2 wex fspeimfw_0 fspeimfw_1 wi fspeimfw_2 wex fspeimfw_2 fspeimfw_3 weq wn fspeimfw_2 wal wn fspeimfw_0 fspeimfw_2 wal fspeimfw_1 fspeimfw_2 wex wi fspeimfw_2 fspeimfw_3 weq fspeimfw_0 fspeimfw_1 wi fspeimfw_2 espeimfw_0 eximi fspeimfw_2 fspeimfw_3 weq fspeimfw_2 df-ex fspeimfw_0 fspeimfw_1 fspeimfw_2 19.35 3imtr3i $.
$}
$( Specialization, with additional weakening to allow bundling of ` x ` and
       ` y ` .  Uses only Tarski's FOL axiom schemes.  (Contributed by NM,
...
${
	...
	ax11i $p |- ( x = y -> ( ph -> A. x ( x = y -> ph ) ) ) $= fax11i_2 fax11i_3 weq fax11i_0 fax11i_1 fax11i_2 fax11i_3 weq fax11i_0 wi fax11i_2 wal eax11i_0 fax11i_1 fax11i_2 fax11i_3 weq fax11i_0 wi fax11i_2 eax11i_1 fax11i_2 fax11i_3 weq fax11i_0 fax11i_1 eax11i_0 biimprcd alrimih syl6bi $.
$}
$c [  $.
$( Left bracket $)
$c /  $.
...
${
	...
	fsbequ2_1 $f set x $.
	fsbequ2_2 $f set y $.
	sbequ2 $p |- ( x = y -> ( [ y / x ] ph -> ph ) ) $= fsbequ2_0 fsbequ2_1 fsbequ2_2 wsb fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wi fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wa fsbequ2_1 wex wa fsbequ2_1 fsbequ2_2 weq fsbequ2_0 fsbequ2_0 fsbequ2_1 fsbequ2_2 df-sb fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wi fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wa fsbequ2_1 wex wa fsbequ2_1 fsbequ2_2 weq fsbequ2_0 fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wi fsbequ2_1 fsbequ2_2 weq fsbequ2_0 wa fsbequ2_1 wex simpl com12 syl5bi $.
$}
...
${
	...
	fsb1_1 $f set x $.
	fsb1_2 $f set y $.
	sb1 $p |- ( [ y / x ] ph -> E. x ( x = y /\ ph ) ) $= fsb1_0 fsb1_1 fsb1_2 wsb fsb1_1 fsb1_2 weq fsb1_0 wi fsb1_1 fsb1_2 weq fsb1_0 wa fsb1_1 wex fsb1_0 fsb1_1 fsb1_2 df-sb simprbi $.
$}
...
${
	...
	fsbimi_3 $f set y $.
	esbimi_0 $e |- ( ph -> ps ) $.
	sbimi $p |- ( [ y / x ] ph -> [ y / x ] ps ) $= fsbimi_2 fsbimi_3 weq fsbimi_0 wi fsbimi_2 fsbimi_3 weq fsbimi_0 wa fsbimi_2 wex wa fsbimi_2 fsbimi_3 weq fsbimi_1 wi fsbimi_2 fsbimi_3 weq fsbimi_1 wa fsbimi_2 wex wa fsbimi_0 fsbimi_2 fsbimi_3 wsb fsbimi_1 fsbimi_2 fsbimi_3 wsb fsbimi_2 fsbimi_3 weq fsbimi_0 wi fsbimi_2 fsbimi_3 weq fsbimi_1 wi fsbimi_2 fsbimi_3 weq fsbimi_0 wa fsbimi_2 wex fsbimi_2 fsbimi_3 weq fsbimi_1 wa fsbimi_2 wex fsbimi_0 fsbimi_1 fsbimi_2 fsbimi_3 weq esbimi_0 imim2i fsbimi_2 fsbimi_3 weq fsbimi_0 wa fsbimi_2 fsbimi_3 weq fsbimi_1 wa fsbimi_2 fsbimi_0 fsbimi_1 fsbimi_2 fsbimi_3 weq esbimi_0 anim2i eximi anim12i fsbimi_0 fsbimi_2 fsbimi_3 df-sb fsbimi_1 fsbimi_2 fsbimi_3 df-sb 3imtr4i $.
$}
